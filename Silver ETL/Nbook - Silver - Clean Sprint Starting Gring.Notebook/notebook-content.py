...
df_src = spark.sql(
    "SELECT * FROM Lake_F1_Silver.staging.Sprint_Starting_Grid" 
)
...
#display(df_final)
df_final.write.format("delta").mode("overwrite").saveAsTable("Lake_F1_Silver.clean.Sprint_Starting_Grid")
